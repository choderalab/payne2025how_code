...
workflow PLIF_X_TO_X_POSIT_1_0        { RUN_ANALYSIS(plif_result, [label: "x_to_x_plif1.0",        filename: sp10.x_to_x]) }
workflow PLIF_X_TO_X_5_POSIT_1_0      { RUN_ANALYSIS(plif_result, [label: "x_to_x_5_plif1.0",      filename: sp10.x_to_x_5]) }
workflow PLIF_NOT_X_TO_X_POSIT_1_0    { RUN_ANALYSIS(plif_result, [label: "not_x_to_x_plif1.0",    filename: sp10.not_x_to_x]) }
workflow PLIF_NOT_X_TO_X_5_POSIT_1_0  { RUN_ANALYSIS(plif_result, [label: "not_x_to_x_5_plif1.0",  filename: sp10.not_x_to_x_5]) }
workflow PLIF_X_TO_NOT_X_POSIT_1_0    { RUN_ANALYSIS(plif_result, [label: "x_to_not_x_plif1.0",    filename: sp10.x_to_not_x]) }
